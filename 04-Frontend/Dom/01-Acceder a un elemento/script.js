//cuales son las formas o los metodos para acceder a los elementos del DOM?

// 1. getElementById: Devuelve un objeto que contiene un id, devuelve un objeto de HTML que seleccionamos por su id (BUSCAR POR ID)
//EJEMPLO 1
...
// 2. getElementByClassName: obtener lista de elementos HTML por su clase
//EJEMPLO 1
...
// 4. querySelector: devuelve elm primer elemento que coincida con la busqueda, puede ser por nombre, etiqueta, clase o id
...
/*FORMA DE PONERLE UN TEXTO A UN HTML DESDE JAVA SCRIPT:
- innertext
- innerhtml
- textcontent
*/
